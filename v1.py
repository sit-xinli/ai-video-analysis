...
With the context message, describe what is happening in the scene in Japanese."""
...
def analyze_video(video_path):
    ...
    for i, chunk in enumerate(audio_chunks):
        ...
        if i < len(frames): # Ensure we have a frame for this segment
            caption = caption_image(frames[i]) # Caption image using BLIP--will be change to CHATGPT
        else:
